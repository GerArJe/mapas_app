...
final languageValues = EnumValues(map: {"es": Language.ES, "fr": Language.FR});

enum ShortCode { US_NY, US }

final shortCodeValues =
    EnumValues(map: {"us": ShortCode.US, "US-NY": ShortCode.US_NY});
...
class EnumValues<T> {
  ...
  EnumValues({required this.map, this.reverseMap = null});
